...
<div class="admin-page">
  ...
  <form class="filters" method="get" action="<?= site_url('admin/riwayat') ?>" role="search" data-autosubmit data-live-search>
    <div class="field filters__search">
      <label for="a-q">Cari (keterangan, alasan, pemilih, admin)</label>
      <span class="search-field"><?= icon('search', 'search-field__icon') ?><input type="search" id="a-q" name="q" value="<?= esc($query, 'attr') ?>" maxlength="100" autocomplete="off"></span>
    </div>
    <div class="field">
