...
<div class="admin-page">
  ...
  <ol class="steps" aria-label="Tahapan unlock">
    <li class="steps__item is-current" aria-current="step"><span class="steps__node" aria-hidden="true">01</span><span class="steps__label">Cari pemilih</span></li>
    <li class="steps__item"><span class="steps__node" aria-hidden="true">02</span><span class="steps__label">Lihat status suara</span></li>
    <li class="steps__item"><span class="steps__node" aria-hidden="true">03</span><span class="steps__label">Isi alasan</span></li>
    <li class="steps__item"><span class="steps__node" aria-hidden="true">04</span><span class="steps__label">Konfirmasi</span></li>
  </ol>

  <form class="search-hero" method="get" action="<?= site_url('admin/buka-kunci') ?>" role="search" data-live-search>
    <label for="q" class="search-hero__label">Cari siswa atau guru</label>
    <div class="search-hero__row">
      <span class="search-field"><?= icon('search', 'search-field__icon') ?><input type="search" id="q" name="q" value="<?= esc($query, 'attr') ?>" maxlength="100" placeholder="Nama, NISN, atau NIP" autocomplete="off" autofocus></span>
  ...
  <section class="panel" aria-labelledby="recent-title">
    <header class="panel__head">
      ...
      <a class="panel__link" href="<?= site_url('admin/riwayat?action=UNLOCK_VOTE') ?>">Selengkapnya<span class="visually-hidden">: audit log unlock</span> <?= icon('arrow-right') ?></a>
    </header>
    <?php if ($recent === []): ?>
