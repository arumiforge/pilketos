  ...
  <div class="container site-nav__row">
    ...
    <nav class="site-nav__actions" aria-label="Navigasi utama">
      <?php if ($userType === 'student'): ?>
        <a href="<?= base_url('student/dashboard') ?>" class="btn btn--sm btn--outline">Dasbor Siswa</a>
      <?php elseif ($userType === 'teacher'): ?>
        <a href="<?= base_url('teacher/dashboard') ?>" class="btn btn--sm btn--outline">Dasbor Guru</a>
      <?php elseif ($userType === 'admin'): ?>
        <a href="<?= base_url('admin/dashboard') ?>" class="btn btn--sm btn--outline">Dasbor Admin</a>
      <?php else: ?>
