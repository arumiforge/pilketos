...
final class AuthTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->postForm('student/login', ['nisn' => '0000000001', 'kodeunik' => '05062013']);

        $result->assertRedirectTo(site_url('student/dashboard'));
    ...
    {
        $result = $this->postForm('student/login', ['nisn' => '0000000003', 'kodeunik' => '01-03-2013']);
    ...
    {
        $result = $this->postForm('student/login', ['nisn' => '0000000001', 'kodeunik' => '01012000']);
    ...
    {
        $result = $this->postForm('student/login', ['nisn' => '0000000001', 'kodeunik' => 'abc']);
    ...
    {
        $this->postForm('student/login', ['nisn' => '0000000012', 'kodeunik' => '08032011']);
    ...
    {
        $result = $this->postForm('teacher/login', ['nip' => '000000000000000004', 'kodeunik' => '01061992']);

        $result->assertRedirectTo(site_url('teacher/dashboard'));
    ...
    {
        $this->postForm('teacher/login', ['nip' => '000000000000000005', 'kodeunik' => '25121988']);
    ...
    {
        $this->postForm('teacher/login', ['nip' => '0000000001', 'kodeunik' => '05062013']);
    ...
    {
        $result = $this->postForm('admin/login', ['username' => 'admin', 'password' => 'admin123']);
    ...
    {
        $result = $this->postForm('admin/login', ['username' => 'admin', 'password' => 'salah']);
    ...
    {
        $this->postForm('student/login', ['nisn' => 'admin', 'kodeunik' => 'admin123']);
    ...
    {
        $this->postForm('student/login', ['nisn' => '0000000001', 'kodeunik' => '05062013']);

        $this->assertNotContains('05062013', array_filter($_SESSION, 'is_string'));
        $this->assertArrayNotHasKey('_ci_old_input', $_SESSION);

        $this->postForm('admin/login', ['username' => 'admin', 'password' => 'salah']);
    ...
    public function testLoginAsAnotherRoleClearsPreviousIdentity(): void
    {
        $this->withSession(['user_type' => 'admin', 'admin_id' => 1, 'isLoggedIn' => true])
            ->postForm('student/login', ['nisn' => '0000000001', 'kodeunik' => '05062013']);
    ...
    {
        $this->get('student/dashboard')->assertRedirectTo(site_url('student/login'));
        $this->get('teacher/dashboard')->assertRedirectTo(site_url('teacher/login'));
        $this->get('admin/dashboard')->assertRedirectTo(site_url('admin/login'));
    }

    public function testAjaxGuestReceivesJson401(): void
    {
        $result = $this->withHeaders(['X-Requested-With' => 'XMLHttpRequest'])->get('admin/dashboard');
    ...
    public function testStudentCannotAccessTeacherOrAdminRoutes(): void
    {
        ...
        $this->withSession($session)->get('student/dashboard')->assertStatus(200);
        $this->withSession($session)->get('teacher/dashboard')->assertRedirectTo(site_url('teacher/login'));
        $this->withSession($session)->get('admin/dashboard')->assertRedirectTo(site_url('admin/login'));
    }
    ...
    public function testTeacherCannotAccessAdminRoutes(): void
    {
        ...
        $this->withSession($session)->get('teacher/dashboard')->assertStatus(200);
        $this->withSession($session)->get('admin/dashboard')->assertRedirectTo(site_url('admin/login'));
    }
    ...
    public function testDeactivatedStudentLosesAccessImmediately(): void
    {
        ...
        $result->assertRedirectTo(site_url('student/login'));
        $this->assertNull(session('user_type'));
    }
    ...
    public function testPostWithoutCsrfTokenIsRejected(): void
    {
        ...
        $this->post('student/login', ['nisn' => '0000000001', 'kodeunik' => '05062013']);
    }

    public function testLoginIsThrottledPerAccountAfterRepeatedFailures(): void
    {
        for ($i = 0; $i < 5; $i++) {
            $this->postForm('student/login', ['nisn' => '0000000002', 'kodeunik' => '0101200' . $i]);
        }

        // Kode benar pun ditolak selama akun sedang diblokir.
        $result = $this->postForm('student/login', ['nisn' => '0000000002', 'kodeunik' => '17092013']);
